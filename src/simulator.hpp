...
/**
 * @brief Simulates a path of an SDE of the form dX = a(X, t) dt + b(X, t) dW using Euler's method.
 * 
...
/**
 * @brief Simulates a path of an SDE of the form dX = a(X, t) dt + b(X, t) dW using Milstein's scheme.
 * 
 * @param x0 Initial value of the process.
 * @param a Drift function a(x, t).
 * @param b Volatility function b(x, t).
